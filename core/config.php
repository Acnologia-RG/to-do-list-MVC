...
define('DB_NAME', 'to-do_list'); 	// Wat is de database naam
define('DB_USER', 'root'); 		// Wat is de database gebruiker
define('DB_PASS', 'school');		// Wat is het database wachtwoord
...
define('DEFAULT_CONTROLLER', 'Todolist'); // Dit is de standaard controller waarmee de webapplictie wordt opgestart
